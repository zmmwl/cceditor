...
func initSDKNode() {
	sdkPath := "/Users/zmmwl/dev/blockchain/hyperledger/fabric/src"

	sdkNode = &Node{Name: "Fabric", Path: sdkPath, IconSkin: "ico-ztree-dir-api ", Type: "d",
		Creatable: false, Removable: false, IsGoAPI: true, Children: []*Node{}}

	walk(sdkPath, sdkNode, false, false, true)
}
